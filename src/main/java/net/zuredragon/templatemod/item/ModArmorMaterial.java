...
public enum ModArmorMaterial implements ArmorMaterial {
    SILVERINGOT("silveringot", 25, new int[] { 3, 7, 6, 3 }, 26,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0f, 0f, () -> Ingredient.ofItems(ModItems.SILVERINGOT));
    ;
    ...
    public String getName() {
        return TemplateMod.MOD_ID + ":" + this.name;
    }
